        ...
        <group rotation={[Math.PI / 2, 0, 0]}>
          ...
          <group position={[0.663, 0.484, 3.11]} rotation={[0.165, 0.101, -0.017]} scale={0.906}>
            <mesh
              ...
              material={materials["930_plastics"]}
            />
            {/* <mesh onPointerOver={(e) => handlePointerOver(e)} onPointerOut={handlePointerOut} geometry={nodes.Object_45.geometry} material={materials['930_chromes']} /> */}
          </group>
          <group position={[0.014, 1.667, 0.653]} scale={0.058}>
            {/* <mesh onPointerOver={(e) => handlePointerOver(e)} onPointerOut={handlePointerOut} geometry={nodes.Object_55.geometry} material={materials.black} /> */}
            <mesh
              onPointerOver={(e) => handlePointerOver(e)}
              onPointerOut={handlePointerOut}
          ...
          />
          {/* <mesh onPointerOver={(e) => handlePointerOver(e)} onPointerOut={handlePointerOut} geometry={nodes.Object_32.geometry} material={materials.coat} /> */}
          <mesh
            onPointerOver={(e) => handlePointerOver(e)}
            onPointerOut={handlePointerOut}
